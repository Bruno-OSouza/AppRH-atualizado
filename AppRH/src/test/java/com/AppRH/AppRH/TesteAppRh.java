...
public class TesteAppRh extends AppRhApplicationTests {
	...
	// Inicio dos testes de Rotas e de Métodos.
	...
	final void testRotas() throws Exception {
		...
		//rota detalhes vaga
		mockMvc.perform(get("/detalhes-vaga/1_")).andExpect(status().isOk());
	...
	public void testaSalarioMaiorQue30000() {
		...
		assertEquals(new BigDecimal("0"), vaga.validaSalario(new BigDecimal("30001.00")));
	}
